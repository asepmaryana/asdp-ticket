...
$config['auth_override_class_method_http']['cabang']['lists']['get'] = 'none';
$config['auth_override_class_method_http']['dermaga']['lists']['get'] = 'none';
$config['auth_override_class_method_http']['kapal']['lists']['get'] = 'none';
$config['auth_override_class_method_http']['role']['lists']['get'] = 'none';
$config['auth_override_class_method_http']['tiket']['lists']['get'] = 'none';
$config['auth_override_class_method_http']['tiket']['cek']['get'] = 'none';
$config['auth_override_class_method_http']['tiket']['update']['post'] = 'none';
$config['auth_override_class_method_http']['tiket']['rekap']['get'] = 'none';
...
|
*/
$config['rest_keys_table'] = 'acc_keys';
